...
?>
	...
	<form method="post" enctype="multipart/form-data">
		<div class="form-group">
			<label>Analyst</label>
			<input type="text" name="data[posted_by]" required value="{{ $data->posted_by }}" class="form-control">
		...
		<div class="form-group">
			...
			<input type="text" name="data[analyst_post]" required value="{{ $data->analyst_post }}" class="form-control">
	...
	<div id="hidden-block" style="display:none">
		<div class="form-group" id="image">
			@if($data->asset_type == 'image') 
				<img src="{{ route('get-image-asset-type-filename', ['company-summary', $data->asset]) }}" height="150px">
			@endif
