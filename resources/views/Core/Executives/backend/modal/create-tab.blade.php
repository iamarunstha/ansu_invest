  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{ route('admin-executives-tab-create-post') }}">
        	<div class="form-group">
	        	<label for="data[tab_name]">Tab Name</label>
	        	<input type="text" name="data[tab_name]" value="{{ request()->old('data.summary') }}" placeholder="Enter new tab_name">
	        </div>
