...
?>
	<form method="post" enctype="multipart/form-data">
		...
		<a href="{{ route('admin-experts-list-get') }}" class="btn btn-info">Cancel</a>
	</form>

	<div id="hidden-block" style="display:none">
		<div class="form-group" id="image">
			@if($data->asset_type == 'image') 
				<img src="{{ route('get-image-asset-type-filename', ['experts', $data->asset]) }}" height="150px">
			@endif
	...
	<input type="hidden" id="prabal-ajax-upload-image-directory" value="experts">
	<input type="hidden" id="prabal-ajax-upload-image-asset-type" value="experts">
