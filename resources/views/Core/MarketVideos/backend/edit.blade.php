...
?>
	<form method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<input type="number" name="data[ordering]" class="form-control" value="{{ $data->ordering  }}" min=0 step=1>
	...
	<div id="hidden-block" style="display:none">
		<div class="form-group" id="image">
			@if($data->asset_type == 'image') 
				<img src="{{ route('get-image-asset-type-filename', ['market-videos', $data->asset]) }}" height="150px">
			@endif
