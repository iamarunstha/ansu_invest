		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<button type="button" href="{{route('admin-company-valuation-upload-excel', $company_id)}}" class="btn btn-info form-control" id="download-sample">Download Sample</button>
